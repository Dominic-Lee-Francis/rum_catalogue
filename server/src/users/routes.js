...
router.put("/:username/updateFullName", controller.updateUserFullName);
router.put("/:username/updateDistrict", controller.updateUserDistrict);
router.put("/:username/updatePassword", controller.updateUserPassword);
